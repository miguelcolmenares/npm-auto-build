...
# Script para probar el action localmente con debug
echo "🧪 Testing npm-auto-build action locally (debug)..."
...
# Ejecutar el container Docker de debug
docker run --rm \
